...
from humanoid.algo.mh_ppo.mh_rollout_storage import MHRolloutStorage
...
class MH_PPO:
    ...
    def __init__(
        ...
        self.storage: MHRolloutStorage = None  # type: ignore
        self.transition = MHRolloutStorage.Transition()
    ...
    def init_storage(
        self, training_type, num_envs, num_transitions_per_env, actor_obs_shape, critic_obs_shape, actions_shape, num_rew_fn
    ):
