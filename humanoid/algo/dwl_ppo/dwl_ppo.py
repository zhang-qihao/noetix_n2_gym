...
from humanoid.algo.dwl_ppo.dwl_rollout_storage import DWLRolloutStorage
...
class DWL_PPO:
    ...
    def __init__(
        ...
        self.storage: DWLRolloutStorage = None  # type: ignore
        self.transition = DWLRolloutStorage.Transition()
    ...
    def init_storage(
        ...
        # create rollout storage
        self.storage = DWLRolloutStorage(
            training_type,
            num_envs,
    ...
    def update(self):  # noqa: C901
        ...
        for (
            ...
            # Estimate loss
            denoise_loss = self.policy.compute_loss(obs_batch, critic_obs_batch, masks_batch, hid_states_batch[0])
            ...
            mean_estimate_loss += denoise_loss.item()
            # -- RND loss
