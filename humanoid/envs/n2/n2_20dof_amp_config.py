...
class N2_20DofAMPCfg(LeggedRobotCfg):
    """
    ...
    class motion_loader:
        ...
        reference_motion_file  = glob.glob("datasets/mocap_motions/ning_20dof/locomotion/*")
        num_preload_transitions = 500000
        reference_observation_horizon = 4

class N2_20DofAMPCfgPPO(LeggedRobotCfgPPO):
