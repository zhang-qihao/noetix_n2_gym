...
class N2_18DofAMPCfg(LeggedRobotCfg):
    """
    ...
    class motion_loader:
        ...
        reference_motion_file  = glob.glob("datasets/mocap_motions/ning/locomotion/*")
        num_preload_transitions = 500000
        reference_observation_horizon = 4

class N2_18DofAMPCfgPPO(LeggedRobotCfgPPO):
